namespace MonoGUI
{
    public class VerticalSlider : Widget
    {
        ...
        public override void Draw()
        {
            ...
            // Circle
            Gui.Batch.Draw(Gui.CircleOutline, new(Location.X, Location.Y + Value * Length), null, State == 0 ? Color : Highlight, 0, new(12.5f, 12.5f), Size / 12.5f, SpriteEffects.None, 0f);
        }
